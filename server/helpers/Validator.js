/**
 * Validator to validate input from form.
 * 
 * @author Kelvin Yin
 * @since 1.0.0
 * @version 1.0.0
...
module.exports = {
    ...
    /**
     * This method validate all provided inputs.
     * 
     * @param {Object} formData Data from request body.
     * @param {Object} rules    Validation rules.
     * 
     * @return Errors and data object.
     */
    validate: async (formData, rules) => {
        ...
        if (data.hasOwnProperty('eth_account') && data.hasOwnProperty('eth_private_key')) {
            ...
            if (CarNet.verifyAccount(data.eth_account, data.eth_private_key) === false) {
